...
function draw()
{
    ...
    siblingEdges.push('s4');
    siblingEdges.push('s5');
    siblingEdges.push('s6');
    siblingEdges.push('s7');
    siblingEdges.push('s8');
    siblingEdges.push('s9');
    siblingEdges.push('s10');
    siblingEdges.push('s11');
    siblingEdges.push('s12');
