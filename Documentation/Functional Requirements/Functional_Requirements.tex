...
\item \textbf{Scoring}
		...
		\end{flushleft}
		\begin{center}
  	 	\includegraphics[width=1\textwidth] {./Diagrams/Scoring.jpg}\\[0.4cm]    
		\end{center}
\newpage
	\item \textbf{Substitutions}
		...
		\end{flushleft}
		\begin{center}
		\includegraphics[width=1\textwidth]{./Diagrams/Substitutions.jpg}\\[0.4cm]
		\end{center}
\newpage
...
\newpage
	...
	\item \textbf{Rucks}
		...
		\end{flushleft}
		\begin{center}
		\includegraphics[width=1\textwidth]{./Diagrams/Ruck.jpg}\\[0.4cm]
		\end{center}
\newpage
	\item \textbf{Mauls}
		\begin{flushleft}
...
\begin{itemize}
	...
	\item Scoring
		\begin{center}
		\includegraphics[width=1\textwidth] {./Diagrams/ScoringActivityDiagram.jpg}\\[0.4cm]
		\end{center}
\newpage
	\item Substitutions
		\begin{center}
		\includegraphics[width=1\textwidth] {./Diagrams/SubstitutionsActivityDiagram.jpg}\\[0.4cm]
		\end{center}
	\item Discipline
		\begin{center}
